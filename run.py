...
option_transfer_type = 'face with smile'
...
os.system('rlaunch --gpu=1 --cpu=4 --memory=10240 -- python3 src/global_run.py  --transfer_type \'{}\' --data_type \'{}\' --beta {} --alpha {}'.format(option_transfer_type, option_data_type, option_beta, option_alpha))
