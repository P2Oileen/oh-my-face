...
This project is based on [StyleCLIP](https://github.com/orpatashnik/StyleCLIP), [Practical-RIFE](https://github.com/hzwer/Practical-RIFE), and [encoder4editing](https://github.com/omertov/encoder4editing), which aims to expand human face editing via Global Direction of StyleCLIP, especially to maintain similarity before and after editing. 

StyleCLIP is an excellent algorithm that acts on the latent code of StyleGAN2, which aims to edit images guided by texts. Global Direction uses models such as e4e to convert images into latent codes and then further editing. However, this conversion causes information loss of the original image and dissimilarities.
